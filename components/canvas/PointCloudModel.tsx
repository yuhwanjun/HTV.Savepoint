...
const PHASE_SHAPES: Record<string, 'sphere' | 'cube' | 'torus' | 'cone' | 'diamond'> = {
  p1_beginning: 'sphere',
...
export default function PointCloudModel({ nodeId, nodeType, pointCloudPath }: PointCloudModelProps) {
